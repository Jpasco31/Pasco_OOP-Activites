...
public class Main {
    public static void main(String[] args) {
        ...
        //Commission Employee
        CommissionEmployee commissionE1 = new CommissionEmployee(3,"Joe", new Date(19,5,2019),
                new Date(18,9,1996), 250000);
        commissionE1.displayInfo();

        CommissionEmployee commissionE2 = new CommissionEmployee(9,"Mina", new Date(26,7,2023),
                new Date(24,3,1997));
        ...
        //Base Plus Commission Employee
         BasePlusCommissionEmployee baseE1 = new BasePlusCommissionEmployee(4,"Jihyo", new Date(18,8,2023),
                new Date(1,2,1997), 700000, 150000);
        baseE1.displayInfo();

        BasePlusCommissionEmployee baseE2 = new BasePlusCommissionEmployee(11,"Chaeyoung", new Date(20,10,2015),
                new Date(23,4,1999));
