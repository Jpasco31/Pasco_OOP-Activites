...
public class Main {
    public static void main(String[] args) {
        ...
        //HOURLY EMPLOYEE
        HourlyEmployee hourlyE1 = new HourlyEmployee(1,new Name("Jericho", "Pasco", "Clam"), new Date(21,4,2020),
                new Date(31,12,2000), 60, 200);
        hourlyE1.displayInfo();

        HourlyEmployee hourlyE2 = new HourlyEmployee(5, new Name("Nayeon", "Im", "Twice", "Senior"), new Date(24,6,2022),
                new Date(22,9,1995));
        ...
        hourlyE3.setEmpId(6);
        hourlyE3.setEmpName(new Name("Ms", "Sana", "Minatozaki", "Twice", "Junior"));
        ...
        hourlyE3.setRatePerHour(40);   //negative rate per hour so set to default 0
        hourlyE3.displayInfo();

        //PIECE WORKER EMPLOYEE
        PieceWorkerEmployee pieceWorkerE1 = new PieceWorkerEmployee(2, new Name ("John", "Pasco", "Clam"), new Date(22,3,2021),
                new Date(8,10,2002), 251, 60);
        pieceWorkerE1.displayInfo();

        PieceWorkerEmployee pieceWorkerE2 = new PieceWorkerEmployee(7, new Name("Momo", "Hirai", "Twice", "Senior"), new Date(26,7,2023),
                new Date(9,11,1996));
        ...
        pieceWorkerE3.setEmpName(new Name("Mr","Jeongyeon", "Yoo", "Twice", "II"));
        ...
        //Commission Employee
        CommissionEmployee commissionE1 = new CommissionEmployee(3, new Name("Joe", "Pasco", "Clam"), new Date(19,5,2019),
                new Date(18,9,1996), 250000);
        commissionE1.displayInfo();

        CommissionEmployee commissionE2 = new CommissionEmployee(9, new Name("Mina", "Myoui", "Twice", "III"), new Date(26,7,2023),
                new Date(24,3,1997));
        ...
        commissionE3.setEmpName(new Name ("Dr", "Dahyun", "Kim", "Twice", "IV"));
        ...
        //Base Plus Commission Employee
         BasePlusCommissionEmployee baseE1 = new BasePlusCommissionEmployee(4, new Name("Jihyo", "Park", "Twice"), new Date(18,8,2023),
                new Date(1,2,1997), 700000, 150000);
        baseE1.displayInfo();

        BasePlusCommissionEmployee baseE2 = new BasePlusCommissionEmployee(11, new Name("Chaeyoung","Son", "Twice", "FOURTH"), new Date(20,10,2015),
                new Date(23,4,1999));
        baseE2.setTotalSales(80000);
        baseE2.setBaseSalary(200000);
        baseE2.displayInfo();

        BasePlusCommissionEmployee baseE3 = new BasePlusCommissionEmployee();
        baseE3.setEmpId(12);
        baseE3.setEmpName(new Name("Lady","Tzuyu","Chou", "Twice", "FIFTH"));
